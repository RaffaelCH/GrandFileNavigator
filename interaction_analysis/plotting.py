...
interaction_types = ["Scroll", "ChangeVisibleRanges", "ChangeFile",
                     "EditFile", "EditingSession", "NavigationJump", "ChangeSidebarVisibility"]
color_map = matplotlib.colormaps['tab10']  # Use a standard colormap
type_to_color = {itype: color_map(i / len(interaction_types))
                 for i, itype in enumerate(sorted(interaction_types))}
